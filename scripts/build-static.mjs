...
const files=['index.html','styles.css','favicon.svg','favicon-32x32.png','apple-touch-icon.png','icon-192.png','icon-512.png','site.webmanifest','robots.txt','.nojekyll','js/app.js','lib/maps.js','lib/label-placement.mjs','lib/reveal-labels.mjs','lib/engines/activities.mjs','lib/engines/drag-controller.mjs','lib/engines/pan-controller.mjs','data/africa.json'];
