...
const files=['index.html','africa/index.html','styles.css','favicon.svg','favicon-32x32.png','apple-touch-icon.png','icon-192.png','icon-512.png','site.webmanifest','robots.txt','.nojekyll','js/app.js','lib/maps.js','lib/learning-reference.mjs','data/africa-learning.json','lib/mnemonics.mjs','lib/practice-subsets.mjs','lib/map-configs.mjs','lib/unit-presentation.mjs','lib/drop-validation.mjs','lib/regions.mjs','lib/label-placement.mjs','lib/reveal-labels.mjs','lib/engines/activities.mjs','lib/engines/drag-controller.mjs','lib/engines/pan-controller.mjs','data/africa.json','data/canada.json','data/central-america.json','data/south-america.json'];
files.push(...['europe','asia','middle-east'].map(id=>'assets/maps/'+id+'-planned.svg'));
