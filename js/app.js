...
class CountryMaps {
  ...
  renderActivity() {
    ...
    root.innerHTML=(puzzlePage?'<div class="puzzle-top-shell">':'')+'<div class="activity-heading'+(puzzlePage?' puzzle-heading':'')+'"><div>'+activityTitle+'</div><nav class="mode-links" aria-label="'+name+' activities">'+modeLinks+'</nav></div>'+
